...
object MockData {
    ...
    val currentUser = Profile(
        ...
        created = Instant.parse("2025-10-01T12:00:00Z"),
        updated = Instant.parse("2025-10-19T19:00:00Z"),
        userId = "user_001",
        firstName = "Alex",
        lastName = "Chen",
    ...
    val discoverProfiles = listOf(
        Profile(
            ...
            updated = Instant.parse("2025-10-18T15:30:00Z"),
            userId = "user_002",
            firstName = "Jordan",
            lastName = "Rivera",
        ...
        Profile(
            ...
            collectionId = "profiles",
            collectionName = "profiles",
            created = Instant.parse("2025-08-20T08:00:00Z"),
            updated = Instant.parse("2025-10-19T12:00:00Z"),
            userId = "user_003",
            firstName = "Sam",
            lastName = "Taylor",
        ...
        Profile(
            ...
            collectionId = "profiles",
            collectionName = "profiles",
            created = Instant.parse("2025-09-01T14:00:00Z"),
            updated = Instant.parse("2025-10-17T09:00:00Z"),
            userId = "user_004",
            firstName = "Casey",
            lastName = "Morgan",
        ...
        Profile(
            ...
            collectionId = "profiles",
            collectionName = "profiles",
            created = Instant.parse("2025-10-05T11:00:00Z"),
            updated = Instant.parse("2025-10-19T18:00:00Z"),
            userId = "user_005",
            firstName = "Riley",
            lastName = "Park",
        ...
        Profile(
            ...
            collectionId = "profiles",
            collectionName = "profiles",
            created = Instant.parse("2025-09-10T16:00:00Z"),
            updated = Instant.parse("2025-10-16T20:00:00Z"),
            userId = "user_006",
            firstName = "Morgan",
            lastName = "Lee",
