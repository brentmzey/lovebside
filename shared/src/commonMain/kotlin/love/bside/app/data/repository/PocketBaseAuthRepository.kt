...
class PocketBaseAuthRepository(
    ...
    override suspend fun login(email: String, password: String): Result<AuthDetails> {
        ...
        return client.authWithPassword<love.bside.app.data.models.User>(
                ...
                .flatMap { authResponse ->
                    ...
                    client.getFirstListItem<Profile>(
                                    collection = "s_profiles",
                                    filter = "userId='${authResponse.record.id}'"
                            )
                            .onError { e ->
                                logError("Failed to fetch profile for user ${email}: ${e.message}")
                            }
                            .map { profile ->
                                val authDetails =
                                        AuthDetails(
                ...
                SignUpRequest(
                        ...
                        seeking =
                                when (data.seeking) {
                                    ...
                                    DomainSeekingStatus.RELATIONSHIP ->
                                            DataSeekingStatus.RELATIONSHIP
    ...
    override suspend fun getCurrentUserId(): String? {
        return sessionManager.getProfile()?.userId
    }
}
